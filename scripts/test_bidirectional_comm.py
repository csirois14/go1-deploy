...
def get_observation_dict(obs: np.array) -> dict:
    ...
    obs_dict = {
        "base_ang_vel": obs[0:3].flatten(),
        "projected_gravity": obs[3:6].flatten(),
        "velocity_commands": obs[6:9].flatten(),
        "joint_pos": obs[9:21].flatten(),
        "joint_vel": obs[21:33].flatten(),
        "actions": obs[33:45].flatten(),
    }
    return obs_dict
    ...
    try:
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
            ...
            for i in range(50):  # Run for 50 iterations
                ...
                # TODO: Uncomment to send action commands
